select* from salespersons where salesperson_city = 'London';    /*Task 1*/
select* from salespersons where commission_rate=0;    /*Task 2*/
select* from salespersons order by commission_rate desc limit 3;    /*Task 3*/
select* from salespersons where commission_rate<(select avg(commission_rate) from salespersons);    /*Task 4*/
select* from salespersons where commission_rate<(select avg(commission_rate) from salespersons) and salesperson_city= 'London';    /*Task 5*/
select* from salespersons where salesperson_city='Florida' or salesperson_city='Barcelona'or salesperson_city='San Jose';    /*Task 6*/
select* from customers where c_rating= (select min(c_rating) from customers);    /*Task 7*/
select* from customers where c_rating= (select max(c_rating) from customers);    /*Task 8*/
select c_city from customers where c_rating= (select max(c_rating) from customers);    /*Task 9*/
select* from customers order by c_rating desc;    /*Task 10*/
select c_firstname,customerid from customers where (c_firstname like 'j_n' or c_lastname like'j_n');    /*Task 11*/
select avg(amount) from orders;    /*Task 12*/
select max(amount) from orders;    /*Task 12*/
select count(orderid) from orders_bkp;    /*Task 13*/
select monthname(orderdate)as Month, sum(amount) from orders group by monthname(orderdate);    /*Task 14*/
select month(orderdate)as Month, avg(amount) from orders group by month(orderdate);    /*Task 14*/
...
update orders set orderdate='2021-02-01' where orderid=3001;
update orders set orderdate='2021-07-30' where orderid=3002;
update orders set orderdate='2021-10-02' where orderid=3003;
update orders set orderdate='2021-10-09' where orderid=3005;
update orders set orderdate='2021-04-02​' where orderid=3007;
update orders set orderdate='2021-03-06' where orderid=3008;
update orders set orderdate='2021-10-10' where orderid=3009;
update orders set orderdate='2021-02-23' where orderid=3010;
update orders set orderdate='2021-09-18' where orderid=3011;
